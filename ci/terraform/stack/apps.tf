module "csb" {
  ...
  aws_access_key_id_commercial     = data.terraform_remote_state.external.outputs.csb.iam.csb.access_key_id_curr
  aws_secret_access_key_commercial = data.terraform_remote_state.external.outputs.csb.iam.csb.secret_access_key_curr
